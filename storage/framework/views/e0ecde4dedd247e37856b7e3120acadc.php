        ...
        <div class="bot">
            <div id="table">
                <table>
                    ...
                    <tr>
                        <td class="tableitem">
                            <p class="itemtext"> <?php echo e($receipt->product->product_name); ?></p>
                        </td>
                        <td class="tableitem">
                            <p class="itemtext"> <?php echo e($receipt->quality); ?></p>
                        </td>
                        <td class="tableitem">
                            <p class="itemtext"> <?php echo e(number_format($receipt->unitprice,2)); ?></p>
                        </td>
                        <td class="tableitem">
                            <p class="itemtext"> <?php echo e($receipt->discount); ?></p>
                        </td>
                        <td class="tableitem">
                            <p class="itemtext"> <?php echo e(number_format($receipt->amount,2)); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr class="tabletitle">
                        ...
                        <td class="payment">
                            <h2>
                                <?php echo e(number_format($receipt->sum('amount'),2)); ?>
...
</style><?php /**PATH C:\Assignments\ShopPos\resources\views/reports/receipt.blade.php ENDPATH**/ ?>