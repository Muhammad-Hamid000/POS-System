    ...
    <div class="col-md-12">
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-left">
                            ...
                            <tbody class="addMoreProduct">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $productincart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="no"><?php echo e($loop->iteration); ?></td>
                                    <td width="30%">
                                        <input type="text" value="<?php echo e($cart->product->product_name); ?>" class="form-control" style="width: 90%;">
                                    </td>
                                    <td>
                                        <div class="row" style="padding-top:15px">
                                            <div class="col-md-4">
                                                <button wire:click.prevent="IncrementQty(<?php echo e($cart->id); ?>)" class="btn btn-sm btn-success" style="text-align:left; display:flex;align-items: center;justify-content: center;">
                                            ...
                                            <div class="col-md-4">
                                                <button wire:click.prevent="DecrementQty(<?php echo e($cart->id); ?>)" class="btn btn-sm btn-danger" style="text-align:left; display:flex;align-items: center;justify-content: center;">
                                    ...
                                    <td>
                                        <input type="number" value="<?php echo e($cart->product->price); ?>" class="form-control price" style="width: 90%;">
                                    </td>
                                    ...
                                    <td>
                                        <input type="number" value="<?php echo e($cart->product_qty * $cart->product->price); ?>" class="form-control total_amount" style="width: 90%;">
                                    </td>
                                    <td><a href="#" class="btn btn-sm btn-danger">
                                            <i class="fa fa-times" wire:click.prevent="removeproduct(<?php echo e($cart->id); ?>)"></i>
                                        </a></td>
                                </tr>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-header">
                        <h4>Total <b class="total"><?php echo e($productincart->sum('product_price')); ?></b></h4>
                        <input type="hidden" name="total" id="totalInput" value="">
                    </div>
                    <form action="<?php echo e(route('orders.store')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $productincart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" value="<?php echo e($cart->product->id); ?>" name="product_id[]" class="form-control" style="width: 90%;">
                        <input type="hidden" name="quantity[]" value="<?php echo e($cart->product_qty); ?>">
                        <input type="hidden" value="<?php echo e($cart->product->price); ?>" name="price[]" class="form-control price" style="width: 90%;">
                        <input type="hidden" name="discount[]" id="discount" class="form-control discount" style="width: 90%;">
                        <input type="hidden" value="<?php echo e($cart->product_qty * $cart->product->price); ?>" name="total_amount[]" class="form-control total_amount" style="width: 90%;">
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
...
</div><?php /**PATH C:\Assignments\ShopPos\resources\views/livewire/ordere.blade.php ENDPATH**/ ?>